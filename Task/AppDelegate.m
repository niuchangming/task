...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [WXApi registerApp:@"wxd930ea5d5a258f4f" withDescription:@"task"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "ekoolab.Task" in the application's documents directory.
